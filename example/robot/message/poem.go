...
var (
	//https://github.com/chinese-poetry/chinese-poetry/blob/master/shijing/shijing.json
	contenJson = `[
  {
    "title": "关雎",
    "chapter": "国风",
  ...
  },
  {
    ...
    "section": "王风",
    "content": [
      "中谷有蓷，暵其干矣。有女仳离，慨其矣。慨其矣，遇人之艰难矣。",
  ...
  },
  {
    ...
    "content": [
      ...
      "夙夜匪解，虔共尔位，朕命不易。粲不庭方，以佐戎辟。",
      "四牡奕奕，孔修且张。韩侯入觐，以其介圭，入觐于王。王锡韩侯，淑旂绥章，",
      "簟茀错衡，玄衮赤舄，钩膺镂锡，鞹鞃浅幭，鞗革金厄。",
      "韩侯出祖，出宿于屠。显父饯之，清酒百壶。其殽维何？炰鳖鲜鱼。其蔌维何？",
      "维笋及蒲。其赠维何？乘马路车。笾豆有且。侯氏燕胥。",
      "韩侯取妻，汾王之甥，蹶父之子。韩侯迎止，于蹶之里。百两彭彭，八鸾锵锵，",
      "不显其光。诸娣从之，祁祁如云。韩侯顾之，烂其盈门。",
      "蹶父孔武，靡国不到。为韩姞相攸，莫如韩乐。孔乐韩土，川泽訏訏，鲂鱮甫甫，",
      "麀鹿噳噳，有熊有罴，有猫有虎。庆既令居，韩姞燕誉。",
      "溥彼韩城，燕师所完。以先祖受命，因时百蛮。王锡韩侯，其追其貊。奄受北国，",
      "因以其伯。实墉实壑，实亩实藉。献其貔皮，赤豹黄罴。"
    ]
  },
  {
    "title": "江汉",
...
func init() {
	_ = json.Unmarshal([]byte(contenJson), &messages)
	messageSize = len(messages)
}

func RandomPoem() (int, *Poem) {
	i, _ := random.Intn(messageSize)
	return i, &messages[i]
}
